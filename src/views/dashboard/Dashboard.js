    ...
    <CButton className='dashboard-button' color="info" variant="outline" onClick={() => setVisible(!visible)}>Create Room</CButton>
      ...
      >
        ...
        <CModalBody>
          ...
          <CFormInput type="text" name='splName' placeholder="Insert Room Name" aria-label="default input example"/>
          <CFormLabel className='description' htmlFor="exampleFormControlTextarea1">Description: </CFormLabel>
          <CFormTextarea name='spldes'  id="exampleFormControlTextarea1" rows="3"></CFormTextarea>
        </CModalBody>
        <CModalFooter>
                ...
                spls.map(spl => ( 
                  ...
                  <CCardImage orientation="top" src={reactIMG}/>
                    <CCardBody >
                      ...
                      <CNavLink to={'/spls/'+spl.join_code} className="stretched-link" component={NavLink}>
              Dashboard
            </CNavLink>
                      {/* <a href="./dashboard/projects" className="stretched-link"></a> */}
                    </CCardBody>
                    <CCardFooter>
                      <small className="text-medium-emphasis">join code: {spl.join_code}</small>
                    </CCardFooter>
                  </CCard>
                </CCol>)
                )
